...
let num2:number = 121;
let clone_num2:number = num2;
let rever_num2:number = 0;

while(num2>0){
    let digit2:number = num2 % 10;
...
let no_3:number = 7;   document.write("<i>the given no is = </i> ",no_3+ "<br>");
let a:number = 0; 
let b:number = 1;
document.write('the Fibonacci serise for the given number of times = `')
for(let f:number= 1; f < no_3; f++){
...
for(let f4:number = 1; f4 <= no_4; f4++){
    sum_1 = sum_1*f4;
}
...
let n0_7: number = 12345;
document.write('<i>the given no is = </i>'+n0_7+"<br>")
let sum_3: number = 0;

while (n0_7 > 0) {
    let digit_7: number = n0_7 % 10;
   sum_3 =sum_3 + digit_7;
...
let num_8:number = 153;
document.write('the given no is ='+num_8+"<br>".toString())
let original_no:number = num_8;
let sum_8:number= 0;
let digits_8:number = num_8;

while(num_8>0){
    let digit_8:number= num_8%10;
...
let num_9: number = 2;
let power_9: number = 5;
let result_9: number = 1;

for (let i_9: number = 1; i_9 <= power_9; i_9++) {
...
let empty_star:string = '';

for(let i:number = 5; i>=1 ;i--){
    for(let s:number=5;s>i;s--){
        empty_star += "_ ";
    }
    for(let j:number =1;j<=i;j++){
        empty_star += j+" ";
...
let i_2 = document.write('');
 ...
 for(let i_2: number = 1; i_2 <= 5; i_2++) {

    for(let s: number = 5; s > i_2; s--) {
        star_2 += "_ ";
    }

    for(let j: number = 1; j <= i_2; j++) {
        star_2 += j + " ";
    }
